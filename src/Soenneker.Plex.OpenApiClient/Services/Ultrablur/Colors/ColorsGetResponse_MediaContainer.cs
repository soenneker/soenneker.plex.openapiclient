...
namespace Soenneker.Plex.OpenApiClient.Services.Ultrablur.Colors
{
    ...
    public partial class ColorsGetResponse_MediaContainer : global::Soenneker.Plex.OpenApiClient.Models.MediaContainer, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plex.OpenApiClient.Services.Ultrablur.Colors.ColorsGetResponse_MediaContainer"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Soenneker.Plex.OpenApiClient.Services.Ultrablur.Colors.ColorsGetResponse_MediaContainer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plex.OpenApiClient.Services.Ultrablur.Colors.ColorsGetResponse_MediaContainer();
        }
        /// <summary>
