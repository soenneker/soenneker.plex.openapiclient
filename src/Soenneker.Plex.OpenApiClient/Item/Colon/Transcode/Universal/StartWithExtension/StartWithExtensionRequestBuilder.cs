...
namespace Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension
{
    ...
    public partial class StartWithExtensionRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder.StartWithExtensionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder.StartWithExtensionRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder.StartWithExtensionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder.StartWithExtensionRequestBuilderGetQueryParameters>> requestConfiguration = default)
        {
            ...
            requestInfo.Headers.TryAdd("Accept", "application/vnd.apple.mpegurl, text/html, video/x-matroska");
            return requestInfo;
        }
        /// <summary>
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Starts the transcoder and returns the corresponding streaming resource document.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StartWithExtensionRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            /// <summary>Indicates how incompatible advanced subtitles (such as ass/ssa) should be included: * &apos;burn&apos; - Burn incompatible advanced text subtitles into the video stream * &apos;text&apos; - Transcode incompatible advanced text subtitles to a compatible text format, even if some markup is lost</summary>
            [QueryParameter("advancedSubtitles")]
            public global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.GetAdvancedSubtitlesQueryParameterType? AdvancedSubtitlesAsGetAdvancedSubtitlesQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Network type of the client, can be used to help determine target bitrate.</summary>
            [QueryParameter("location")]
            public global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.GetLocationQueryParameterType? LocationAsGetLocationQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Indicates the network streaming protocol to be used for the transcode session: * &apos;http&apos; - include the file in the http response such as MKV streaming * &apos;hls&apos; - hls stream (RFC 8216) * &apos;dash&apos; - dash stream (ISO/IEC 23009-1:2022)</summary>
            [QueryParameter("protocol")]
            public global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.GetProtocolQueryParameterType? ProtocolAsGetProtocolQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Indicates how subtitles should be included: * &apos;auto&apos; - Compute the appropriate subtitle setting automatically * &apos;burn&apos; - Burn the selected subtitle; auto if no selected subtitle * &apos;none&apos; - Ignore all subtitle streams * &apos;sidecar&apos; - The selected subtitle should be provided as a sidecar * &apos;embedded&apos; - The selected subtitle should be provided as an embedded stream * &apos;segmented&apos; - The selected subtitle should be provided as a segmented stream</summary>
            [QueryParameter("subtitles")]
            public global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.GetSubtitlesQueryParameterType? SubtitlesAsGetSubtitlesQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StartWithExtensionRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Plex.OpenApiClient.Item.Colon.Transcode.Universal.StartWithExtension.StartWithExtensionRequestBuilder.StartWithExtensionRequestBuilderGetQueryParameters>
        {
        }
    }
}
