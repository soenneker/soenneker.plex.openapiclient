...
namespace Soenneker.Plex.OpenApiClient.Status.Sessions.Background
{
    ...
    public partial class BackgroundGetResponse_MediaContainer : global::Soenneker.Plex.OpenApiClient.Models.MediaContainer, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plex.OpenApiClient.Status.Sessions.Background.BackgroundGetResponse_MediaContainer"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Soenneker.Plex.OpenApiClient.Status.Sessions.Background.BackgroundGetResponse_MediaContainer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plex.OpenApiClient.Status.Sessions.Background.BackgroundGetResponse_MediaContainer();
        }
        /// <summary>
