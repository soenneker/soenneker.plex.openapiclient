...
{
    /// <summary>
    /// Builds and executes requests for operations under \downloadQueue\{queueId}\add
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class AddRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/downloadQueue/{queueId}/add?keys={keys}{&advancedSubtitles*,audioBoost*,audioChannelCount*,autoAdjustQuality*,autoAdjustSubtitle*,directPlay*,directStream*,directStreamAudio*,disableResolutionRotation*,hasMDE*,location*,mediaBufferSize*,mediaIndex*,musicBitrate*,offset*,partIndex*,path*,peakBitrate*,photoResolution*,protocol*,secondsPerSegment*,subtitleSize*,subtitles*,videoBitrate*,videoQuality*,videoResolution*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/downloadQueue/{queueId}/add?keys={keys}{&advancedSubtitles*,audioBoost*,audioChannelCount*,autoAdjustQuality*,autoAdjustSubtitle*,directPlay*,directStream*,directStreamAudio*,disableResolutionRotation*,hasMDE*,location*,mediaBufferSize*,mediaIndex*,musicBitrate*,offset*,partIndex*,path*,peakBitrate*,photoResolution*,protocol*,secondsPerSegment*,subtitleSize*,subtitles*,videoBitrate*,videoQuality*,videoResolution*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder.AddRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder.AddRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Plex.OpenApiClient.DownloadQueue.Item.Add.AddRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Available: 0.2.0Add items to the download queue
        /// </summary>
